function Expirience() {
  return (
    <>
      ...
      <div className="text-gray-300 flex flex-col  gap-15 mt-15  px-5 ">
        ...
        <div className="relative">
          <h2 className="font-semibold uppercase">Lagermax Logistics</h2>
          <p className="text-gray-400">
        ...
        <div className="relative">
          <h2 className="font-semibold uppercase">Makarska Touristik </h2>
          <p className="text-gray-400">
            Upkeep and organization in a tourism agency
          </p>
